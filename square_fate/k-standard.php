...
//	3. 以下兩行代碼是作定位用，若不想做其他位置特效，請保留這兩行代碼。{\\alpha&HFF&}

	$s = "{\\pos($Xoffset[$i],$Yoffset)}{\\2cH$color4}";
	$Upper = "{\\pos($UpperXoffset[$i],$UpperYoffset)}{\\2cH$color4}";
	
	$s2 = "{\\pos($Xoffset[$i],$Yoffset)}{\\frz$angle}{\\alpha&HFF&\\fsc200\\1cH&$color4\\rnd$fact}";
	$Upper2 = "{\\pos($UpperXoffset[$i],$UpperYoffset)}{\\frz$angle}{\\alpha&HFF&\\fsc200\\1cH&$color4\\rnd$fact}";
...
//	   須使用{\\K$PreOffset[$i]}{\\K$offset[$i]}。
	...
	$s .= "{\\fad(300,300)}{\\K$PreOffset[$i]}{\\K$offset[$i]}{\\t($t1,$t1,1,\\alpha&HFF&)}";
	$Upper .= "{\\fad(300,300)}{\\K$PreUpperOffset[$i]}{\\K$UpperOffset[$i]}{\\t($t1,$t1,1,\\alpha&HFF&)}";
	
	$s2 .= "{\\fad(300,300)}{\\t($t1,$t3,1,\\1cH&$color2\\alpha&H00&\\fsc100)}";
	$Upper2 .= "{\\fad(300,300)}{\\t($t1,$t3,1,\\1cH&$color2\\alpha&H00&\\fsc100)}";
