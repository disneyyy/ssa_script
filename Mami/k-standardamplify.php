...
//	   須使用{\\K$PreOffset[$i]}{\\K$offset[$i]}。
	...
	$s .= "{\\fad(300,300)}{\\K$PreOffset[$i]}{\\K$offset[$i]}{\\t($t8,$t7, 1, \\fsc90)}{\\t($t7,$EventEnd, 1, \\fsc200)}";
	$Upper .= "{\\fad(300,300)}{\\K$PreUpperOffset[$i]}{\\K$UpperOffset[$i]}{\\t($t8,$t7, 1, \\fsc90)}{\\t($t7,$EventEnd, 1, \\fsc200)}";
