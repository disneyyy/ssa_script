...
//	   須使用{\\K$PreOffset[$i]}{\\K$offset[$i]}。
	...
	$t92=$EventEnd-$t7;
	$scaleT='88';
	$s .= "{\\fad(300,300)}{\\K$PreOffset[$i]}{\\K$offset[$i]}{\\t($t91,$t92,1,\\1vc(FFFFFF,FFFFFF,FFFFFF,FFFFFF)}";
	$Upper .= "{\\fad(300,300)}{\\K$PreUpperOffset[$i]}{\\K$UpperOffset[$i]}{\\t($t91,$t92,1,\\1vc(FFFFFF,FFFFFF,FFFFFF,FFFFFF)}";
