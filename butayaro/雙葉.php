...
//	3. 以下兩行代碼是作定位用，若不想做其他位置特效，請保留這兩行代碼。
	...
	$sClone = "{\\move($Xoffset[$i],$Yoffset,$Xoffset[$i],$Y2,$start[$i], $end[$i])}{\\1vc($color[0],$color[1],$color[2],$color[3])}{\\2vc(FFFFFF,FFFFFF,FFFFFF,FFFFFF)}{\\alpha&H66}";
	$UpperClone = "{\\move($UpperXoffset[$i],$UpperYoffset,$UpperXoffset[$i],$YU2,$start[$i], $end[$i])}{\\1vc($color[0],$color[1],$color[2],$color[3])}{\\2vc(FFFFFF,FFFFFF,FFFFFF,FFFFFF)}{\\alpha&H66}";
