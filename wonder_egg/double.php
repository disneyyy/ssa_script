...
//	3. 以下兩行代碼是作定位用，若不想做其他位置特效，請保留這兩行代碼。
	...
	$s = "{\\pos($Xoffset[$i],$Yoffset)}{\\shad2}{\\bord3}{\\3a&H$color1}";
	$Upper = "{\\pos($UpperXoffset[$i],$UpperYoffset)}{\\shad2}{\\bord3}{\\3a&H$color1}";
...
//	   須使用{\\K$PreOffset[$i]}{\\K$offset[$i]}。
	...
	$s .= "{\\fad(300,300)}{\\K$PreOffset[$i]}{\\K$offset[$i]}{\\t($start[$i],$t5,1,\\3a&HFF,\\4a&H44)}{\\t($t3,$EventEnd,1,\\3a&HFF,\\4a&H44)}";
	$Upper .= "{\\fad(300,300)}{\\K$PreUpperOffset[$i]}{\\K$UpperOffset[$i]}{\\t($start[$i],$t5,1,\\3a&HFF,\\4a&H44)}{\\t($t3,$EventEnd,1,\\3a&HFF,\\4a&H44)}";
